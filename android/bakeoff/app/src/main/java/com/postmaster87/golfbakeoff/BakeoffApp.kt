...
class BakeoffApp : Application() {
    ...
    /**
     * Why the previous process died, in Android's own words - killed for memory,
     * frozen, swiped away, crashed. Written into the session so a gap names its
     * cause instead of leaving it to be guessed.
     */
